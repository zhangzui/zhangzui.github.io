...
$(function(){
    ...
    var unread_count = parseInt($('#unread_count').val()) ;
    if (unread_count > 0 ) {
        setTimeout(function(){
            show_top_msg("<a href='?s=/home/notice/index'>你有"+unread_count+"条未读提醒，点击查看</a>",40000);
        }, 1000);
    };
    ...
    function change_page(page_id){
        ...
        $("#qr-page-link").attr("data-src","?s=home/common/qrcode&size=3&url="+encodeURIComponent(cur_page_url) );
        $("#qr-single-link").attr("data-src","?s=home/common/qrcode&size=3&url="+encodeURIComponent(single_page_url));
    ...
    $("#share").click(function(){
        $("#qr-item-link").attr("src",$("#qr-item-link").attr("data-src"));
    ...
    $("#share-page").click(function(){
        ...
        $("#qr-page-link").attr("src",$("#qr-page-link").attr("data-src"));
        $("#qr-single-link").attr("src",$("#qr-single-link").attr("data-src"));
